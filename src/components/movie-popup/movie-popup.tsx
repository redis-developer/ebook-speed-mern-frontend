                ...
                <div className="movie-card-add-popup">
                    ...
                    <div className="movie-card-add-popup-body">
                        <div className="movie-card-add-popup-input-group">
                            <input type="text" className="movie-card-add-popup-input-group-input" required />
                        ...
                        <div className="movie-card-row movie-card-row-split">
                            <div className="movie-card-popup-col movie-card-add-popup-input-group">
                                <select className="movie-card-add-popup-input-group-input" required>
                            ...
                            <div className="movie-card-popup-col movie-card-add-popup-input-group">
                                <input type="number" className="movie-card-add-popup-input-group-input" required />
                        ...
                        <div className="movie-card-add-popup-input-group">
                            <textarea className="movie-card-add-popup-input-group-input movie-card-add-popup-input-group-textarea" required></textarea>
                        ...
                        <div className="movie-card-row movie-card-popup-btn-row">
                            <div className="movie-card-btn movie-card-popup-btn" onClick={() => { evtClickSave() }}>SAVE</div>
                            <div className="movie-card-btn movie-card-popup-btn" onClick={() => { evtClickTogglePopup() }}>CANCEL</div>
                        </div>
                    </div>
